...
# Time Complexity: O(N) because searching could traverse the entire list to retrieve an element.
# Space Complexity: O(N) because we store our entire input into the linked list.