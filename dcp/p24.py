...
# Time Complexity: O(N) because we want to lock/unlock N nodes of the tree.
# Space Complexity: O(N) which is dependent on the numebr of nodes we want to add to the tree.